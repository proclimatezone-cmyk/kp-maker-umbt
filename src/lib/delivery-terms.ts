...
/**
 * Юридический адрес компании — фиксированный блок в конце КП, обычным
 * текстом (не рамка/фигура — прозрачный фон, как у всего остального).
 * Стоит рядом с подписью менеджера (справа от неё), а если подпись
 * отключена или у менеджера не заполнено ФИО — занимает её место слева,
 * чтобы страница не оставалась с дырой с одной стороны.
 */
