...
/**
 * Юридический адрес компании — фиксированный блок в конце КП. Всегда рядом
 * с подпискй менеджера (справа от неё), а если подпись отключена или у
 * менеджера не заполнено ФИО — занимает её место слева, чтобы страница не
 * оставалась с дырой с одной стороны.
 */
